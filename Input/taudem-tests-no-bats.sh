...
# Connect down
run_test "connect down" "Base" "mpiexec -n 8 $TAUDEM_PATH/connectdown -p loganp.tif -ad8 loganad8.tif -w logangw.tif -o loganOutlets.shp -od loganOutlets_Moved.shp -d 1"
...
run_test "ogr dropanalysis gdb lyrname" "peukerDouglas" "mpiexec -n#!/usr/bin/env bash
# filepath: /Users/a01841079/Workspace/SoftwareProjects/TauDEM-Test-Data/TestRunResult/Input/taudem-tests-no-bats.sh
...
run_test "gagewatershed with id" "Base" "mpiexec -n 7 $TAUDEM_PATH/gagewatershed -p loganp.tif -o Outletsmoved.shp -gw logangw.tif -id gwid.txt"
run_test "gagewatershed no id" "Base" "mpiexec -n 4 $TAUDEM_PATH/gagewatershed -p loganp.tif -o Outletsmoved.shp -gw logangw1.tif"
run_test "gagewatershed img with upid" "Base" "mpiexec -n 5 $TAUDEM_PATH/gagewatershed -p logantp.img -o Outletsmoved2.shp -gw logangw1.tif -id gwid1.txt -upid gwup.txt"
...
run_test "connectdown sqlite two layers" "ConnectDown" "mpiexec -n 5 $TAUDEM_PATH/onnectDown -p loganp.tif -ad8 loganad8.tif -w logangw.tif -o loganSample.sqlite -olyr myoutlet1 -od loganSample.sqlite -odlyr myoutlet2 -d 1"
...
run_test "aread8 gdal unset nodata" "GDAL_unset_nodata" "mpiexec -n 4 $TAUDEM_PATH/aread8 aread8 -p p.tif -ad8 ssa.tif -wg weights.tif -nc"
